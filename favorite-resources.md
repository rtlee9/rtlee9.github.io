...
subtitle: Guides, introductions, and cheatsheets
...
* [A free HTML & CSS tutorial \| MarkSheet](http://marksheet.io/)
* [Awesome Design: UI/UX design resources for developers \| Tony Chan](https://github.com/gztchan/awesome-design)
* [Introduction to React \| SurviveJS](http://survivejs.com/react/introduction/)
* [Introduction to Webpack \| SurviveJS](http://survivejs.com/webpack/introduction/)
* [Introduction to Redux \| Redux](http://redux.js.org/)

## Visualizations
* [Introduction to D3.JS \| Square](https://square.github.io/intro-to-d3/)
...
* [A Visual Git Reference \| Mark Lodato's blog](http://marklodato.github.io/visual-git-guide/index-en.html)
* [Using the Fork-and-Branch Git Workflow \| Scott's Weblog](http://blog.scottlowe.org/2015/01/27/using-fork-branch-git-workflow/)
...
* [PostgreSQL cheatsheet \| Postgres OnLine Journal](http://www.postgresonline.com/downloads/special_feature/postgresql83_psql_cheatsheet.pdf)
...
* [Getting Started \| Elasticsearch](https://www.elastic.co/guide/en/elasticsearch/guide/2.x/getting-started.html)
* [Query-Time Search-as-You-Type \| Elasticsearch](https://www.elastic.co/guide/en/elasticsearch/guide/2.x/_query_time_search_as_you_type.html)
...
* [How to Think Like a Computer Scientist - Python Version \| Green Tea Press](http://www.greenteapress.com/thinkpython/thinkCSpy/html/)
* [Useful libraries for data science in Python \| Sebastian Raschka](https://github.com/rasbt/pattern_classification/blob/master/resources/python_data_libraries.md)
* [Python Tips, Tricks, and Hacks \| Siafoo](http://www.siafoo.net/article/52)
* [Best Practices for Function Arguments \| informIT](http://www.informit.com/articles/article.aspx?p=2314818)
* [A step-by-step SQLAlchemy tutorial \| rmunn.com](http://www.rmunn.com/sqlalchemy-tutorial/tutorial.html)
* [Python's zip, map, and lambda \| Brad Montgomery](https://bradmontgomery.net/blog/2013/04/01/pythons-zip-map-and-lambda/)
* [Python Virtual Environments - a Primer \| Real Python](https://realpython.com/blog/python/python-virtual-environments-a-primer/)
* [Using % and .format() for great good! \| PyFormat](https://pyformat.info/)
...
* [Sankey from Scratch using rCharts, d3.js, and igraph \| TimelyPortfolio](http://timelyportfolio.github.io/rCharts_d3_sankey/example_build_network_sankey.html)
* [The caret Package \| caret](http://topepo.github.io/caret/)
* [Advanced R \| Hadley Wickham](http://adv-r.had.co.nz/)
* [Google's R Style Guide \| Google](https://google.github.io/styleguide/Rguide.xml#indentation)
* [Advanced tips and tricks with data.table \| Andrew Brooks](http://brooksandrew.github.io/simpleblog/articles/advanced-data-table/#method-2-using--and-sd)
* [Publishing R Markdown using Jekyll \| chepec.se](https://chepec.se/2014/07/16/knitr-jekyll.html)
* [Data.Table Rolling Joins \| GormAnalysis](http://gormanalysis.com/r-data-table-rolling-joins/)
